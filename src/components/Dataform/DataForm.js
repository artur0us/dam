        ...
        {!props.listView ?
          ...
          <table class="recent__table noSelect" style={props.loading ? { display: "none" } : {}}>
            <tr>
              ...
              {/* <th class="expired__row">Expired at</th> */}
              <th class="expired__row">
                <select className="sorting__select" onChange={props.onChangeSelect} value={props.sortBy === "expired_at_desc" || props.sortBy === "expired_at_asc" ? 'expired_at_asc' : 'expired_at_desc'}>
                  <option value="date">Expired at</option>
                  <option value="name">Name (expired at)</option>
                </select>
                <a onClick={props.switchSortBy}>
                  <img src="/assets/sortarrow.svg" alt="sortarrow" style={props.sortBy === "expired_at_desc" || props.sortBy === "expired_at_asc" ? { transform: "scaleY(-1)" } : {}} />
                </a>
              </th>
